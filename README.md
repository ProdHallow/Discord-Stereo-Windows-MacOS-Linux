...
**⚠️INSTALLER FOR MAC OS IS NON FUNCTIONAL AS THEY ARE IN TESTING AND HAVE PLACEHOLDERS**
...
- **[UnpackedX (UnpackedX)](https://codeberg.org/UnpackedX)** - [Voice Playgrounds Site](https://discord-voice.xyz/)
