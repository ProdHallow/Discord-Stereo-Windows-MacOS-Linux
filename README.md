...
**WARNING: INSTALLER FOR MAC OS IS NON FUNCTIONAL AS THEY ARE IN TESTING AND HAVE PLACEHOLDERS**
...
|----------|:------:|-------|
| **Windows** | [OK] Active | Full support - GUI patcher with multi-client detection |
| **macOS** | [OK] Active | Bash patcher with auto-detection, code signing handling, Apple Silicon support |
| **Linux** | [OK] Active | Bash patcher with auto-detection - deb, Flatpak, Snap supported |
...
|------------|-------------|:------:|
| **[Discord-Node-Patcher](https://github.com/ProdHallow/Discord-Node-Patcher-Feb-9-2026)** | Windows voice module patcher | [OK] Active |
| **[Discord-Stereo-Installer](https://github.com/ProdHallow/Discord-Stereo-Installer)** | Pre-patched binaries & installer | [OK] Active |
| **[macOS Beta Patcher](https://github.com/ProdHallow/Discord-Stereo-Windows-MacOS-Linux/tree/main/MacOS%20BETA%20PATCHER)** | macOS voice module patcher | [OK] Active |
| **[Linux Beta Patcher](https://github.com/ProdHallow/Discord-Stereo-Windows-MacOS-Linux/tree/main/Linux%20Patcher%20and%20Installer)** | Linux voice module patcher | [OK] Active |
...
- [BETA] **Linux Beta Patcher** - native bash script, auto-detects deb/Flatpak/Snap installs
- [BETA] **macOS Beta Patcher** - native bash script, handles code signing, Apple Silicon (Rosetta) support
...
| 3 | `MonoDownmixer` | Mixes stereo->mono before encoding - NOP sled + unconditional jump bypasses the entire function | 12x `NOP` + `JMP` |
...
| 8 | `SetsBitrateBitwiseOr` | Bitwise OR that caps bitrate - NOP to prevent clamping | 3x `NOP` |
| 9 | `Emulate48Khz` | `cmovb` that clamps sample rate to 24kHz - NOP to allow 48kHz passthrough | 3x `NOP` |
...
> WARNING: **Disclaimer:** Tools provided as-is for research and experimentation. Use at your own risk. Not affiliated with Discord Inc.
