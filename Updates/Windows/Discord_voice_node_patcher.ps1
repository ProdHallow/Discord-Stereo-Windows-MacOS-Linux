...
$Script:SCRIPT_VERSION = "20.0"

# region Offsets (PASTE HERE)

$Script:OffsetsMeta = @{
    FinderVersion     = "discord_voice_node_offset_finder.py v5.12.0"
    DiscordAppVersion = "1.0.9244"
    Size              = 14830008
    MD5               = "48d3ce27e5cf634593f1e50cab00de35"
}

$Script:Offsets = @{
    CreateAudioFrame_ChannelAssign_Mov                      = 0x001394B1
    AudioEncoderOpusConfig_Ctor_Channels_Imm02              = 0x003E7EC4
    CapturedAudioProcessor_MonoDownmix_NopJmp               = 0x000E7356
    CommitAudioCodec_ChannelCount_Imm02                     = 0x00598A3B
    CommitAudioCodec_SuccessBranch_Jmp                      = 0x00598A47
    ApplySettings_BitrateCalcLow_Channels_Mov248k           = 0x00598E66
    ApplySettings_BitrateCalcMid_Channels_Mov248k           = 0x00598E83
    ApplySettings_BitrateCalcHigh_Channels_Mov248k          = 0x00598E98
    RecreateEncoder_BitrateCalcLow_Channels_Mov248k         = 0x0059DD4C
    RecreateEncoder_BitrateCalcMid_Channels_Mov248k         = 0x0059DD69
    RecreateEncoder_BitrateCalcHigh_Channels_Mov248k        = 0x0059DD7E
    SetBitrateClamp_Max248k_Cmp                             = 0x0059DE56
    SetBitrateClamp_Max248k_Mov                             = 0x0059DE5C
    AudioBitrateAdaptorCalc32k_Channels_Mov248k             = 0x00AAA99E
    AudioBitrateAdaptorCalc48k_Channels_Mov248k             = 0x00AAA9B2
    AudioBitrateAdaptorCalc60k_Channels_Mov248k             = 0x00AAA9C3
    SetBitrate_Imm64_Imm248k                                = 0x0059ACC1
    SetBitrate_OrMask_Nop3                                  = 0x0059ACC9
    SetTargetBitrate_Mulss_Nop6                             = 0x0059AD01
    GetMultipliedBitrate_Mulss_Nop7                         = 0x0059B83D
    GetMultipliedBitrate_Entry_IdentityRet                  = 0x0059B800
    SetTargetBitrate_ClampMax248k_Cmp                       = 0x0059AC85
    SetTargetBitrate_ClampMax248k_Mov                       = 0x0059AC8B
    ApplySettings_MaxAvgBitrateClamp248k_Cmp                = 0x00598F70
    ApplySettings_MaxAvgBitrateClamp248k_Mov                = 0x00598F76
    EncoderOpusImpl_RelayClamp248k_Cmp                      = 0x0059AFFC
    EncoderOpusImpl_RelayClamp248k_Mov                      = 0x0059B001
    SelectSampleRate_Cmov48k_Nop3                           = 0x00598BA3
    WebRtcSplHighPass_Dispatch_MovRet                       = 0x005A4CB0
    hp_cutoff_Callback_InjectShellcode                      = 0x00928960
    dc_reject_Callback_InjectShellcode                      = 0x00928B40
    ChannelDownmix_Entry_Ret                                = 0x00924CD0
    AudioEncoderOpusConfig_IsOK_MovTrueRet                  = 0x003E8160
    CodecMismatchThrow_Entry_Ret                            = 0x002FFF10
    AudioEncoderOpusConfig_Ctor_Bitrate_Imm248k             = 0x003E7ECE
    AudioEncoderMultiChannelOpusConfig_Ctor_Bitrate_Imm248k = 0x003E77D7
    AudioEncoderOpusConfig_Ctor_FrameMs_Imm10               = 0x003E7EB5
    AudioEncoderOpusConfig_Ctor_Application_ImmAudio        = 0x003E7ED9
    CELT_Force                                              = 0x00924AC8
    CELT_DefaultMode                                        = 0x00924B44
    NetEqDelayManager_MsPerLoss_Imm0                        = 0x00AF17DD
    PacerBlockAudio_Flag_XorFalse                           = 0x00739122
    SetAutomaticGainControlConfig_Entry_Ret                 = 0x00094840
    SetAutomaticGainControl_Entry_Ret                       = 0x00094BE0
    SetNoiseSuppression_Entry_Ret                           = 0x00094530
    SetEchoCancellation_Entry_Ret                           = 0x00093C00
    SetEchoCancellationPreEcho_Entry_Ret                    = 0x00093F00
    EnableBuiltInAEC_Entry_Ret                              = 0x00093900
    SetNoiseCancellation_Entry_Ret                          = 0x00094F00
    SetNoiseCancellationDuringProcessing_Entry_Ret          = 0x00095A90
}
