...
declare -A OFFSETS=(
    [CreateAudioFrameStereo]=0x140AD3
    [AudioEncoderOpusConfigSetChannels]=0x4E21E5
    [MonoDownmixer]=0x115284
    [EmulateStereoSuccess1]=0x14C49E
    [EmulateStereoSuccess2]=0x14C49F
    [EmulateBitrateModified]=0x14C8FD
    [SetsBitrateBitrateValue]=0x2B0999
    [SetsBitrateBitwiseOr]=0x2B09A1
    [Emulate48Khz]=0x14C606
    [HighPassFilter]=0x47B880
    [HighpassCutoffFilter]=0x4DAE50
    [DcReject]=0x4DB000
    [DownmixFunc]=0x7E37D0
    [AudioEncoderOpusConfigIsOk]=0x4E2380
    [ThrowError]=0x9B8C0
    [DuplicateEmulateBitrateModified]=0x1517E3
    [EncoderConfigInit1]=0x4E21EF
    [EncoderConfigInit2]=0x4E1BC8
)
