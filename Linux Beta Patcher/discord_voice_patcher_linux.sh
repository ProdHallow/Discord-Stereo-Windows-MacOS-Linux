...
EXPECTED_MD5="051ffb79353786dfbff06719ee0b8b16"
EXPECTED_SIZE=78740472

# Linux/ELF offsets — valid ONLY for the binary above
OFFSET_CreateAudioFrameStereo=0x140AD3
OFFSET_AudioEncoderOpusConfigSetChannels=0x4E21E5
OFFSET_MonoDownmixer=0x115284
OFFSET_EmulateStereoSuccess1=0x14C49E
OFFSET_EmulateStereoSuccess2=0x14C49F
OFFSET_EmulateBitrateModified=0x14C8FD
OFFSET_SetsBitrateBitrateValue=0x2B0999
OFFSET_SetsBitrateBitwiseOr=0x2B09A1
OFFSET_Emulate48Khz=0x14C606
OFFSET_HighPassFilter=0x47B880
OFFSET_HighpassCutoffFilter=0x4DAE50
OFFSET_DcReject=0x4DB000
OFFSET_DownmixFunc=0x7E37D0
OFFSET_AudioEncoderOpusConfigIsOk=0x4E2380
OFFSET_ThrowError=0x9B8C0
OFFSET_DuplicateEmulateBitrateModified=0x1517E3
OFFSET_EncoderConfigInit1=0x4E21EF
OFFSET_EncoderConfigInit2=0x4E1BC8
